...
from core.ctor.belief_propag_stringham_clean import PGM, LabeledArray, is_conditional_prob, Messages
...
if __name__ == '__main__':
    ...
    generated_sequence = generator.sample_sequence(generator.get_start_vp(), length=4)
